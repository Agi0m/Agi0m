...
sudo apt update
sudo apt upgrade
apt install geany conky htop neofetch kitty qbittorrent deb-get cmatrix duf
-----------------------------------------------------------------------------------------------------------
flatpak isntall com.discordapp.Discord
flatpak install com.github.tch84.Flatseal
flatpak install com.github.johnfactotum.Foliate
flatpak install com.github.iwalton3.jellyfin-media-player
flatpak install onfo.febvre.Komikku
flatpak install org.libreoffice.Libreoffice
flatpak install net.agalwood.Motrix
flatpak install org.mozilla.Thunderbird
flatpak install net.lutris.Lutris
------------------------------------------------------------------------------------------------------------
sudo apt update
sudo deb-get update
sudo deb-get install jellyfin fd 
...
wget https://github.com/Suwayomi/Tachidesk-Sorayomi/releases/download/0.4.1/tachidesk-sorayomi-0.4.1-linux-x64.tar.gz
